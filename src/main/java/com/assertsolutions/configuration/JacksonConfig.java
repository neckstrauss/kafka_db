...
public class JacksonConfig {
    ...
    @Bean("responseAuditoria")
    public JacksonDataFormat createAuditoriaaJacksonFormat() {
	JacksonDataFormat jacksonDataFormat = new JacksonDataFormat();
        jacksonDataFormat.setPrettyPrint(true);
        jacksonDataFormat.setUnmarshalType(com.assertsolutions.dto.AuditoriaRequest.class);
        jacksonDataFormat.setEnableJaxbAnnotationModule(true);
